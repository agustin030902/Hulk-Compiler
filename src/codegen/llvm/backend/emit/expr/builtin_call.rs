//! Emisión de builtins: `print` (con formato por tipo), las funciones
//! matemáticas delegadas a libm (`sin`, `cos`, `sqrt`, `exp`), `log` con base
//! arbitraria (cociente de logaritmos naturales) y `rand` normalizado a [0,1].
