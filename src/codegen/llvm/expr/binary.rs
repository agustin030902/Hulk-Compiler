...
impl LlvmBackend {
    pub(super) fn emit_binary_expr(&mut self, binary: &BinaryExpr) -> Option<ValueRef> {
    ...
    pub(super) fn emit_numeric_comparison(
        &mut self,
        op: BinaryOp,
        left: &ValueRef,
        right: &ValueRef,
    ...
    pub(super) fn emit_boolean_binary(
        &mut self,
        op: BinaryOp,
        left: &ValueRef,
        right: &ValueRef,
    ...
    pub(super) fn emit_concat(&mut self, left: &ValueRef, right: &ValueRef) -> Option<ValueRef> {
